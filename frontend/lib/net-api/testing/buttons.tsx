...
const PROPOSAL = "BHfCq56FaBYFqnqLSVfx6y9LBnuXteHyC4NC61exXeu2";
...
const ChainTesting = () => {
  ...
  return (
    <div>
      ...
      <Button
        type="button"
        onClick={() => api.getOneTokenProposal(wallet, PROPOSAL)}
      >
      ...
      <Button
        type="button"
        onClick={() =>
          admin.endTokenProposalVotingPeriod(wallet, new PublicKey(PROPOSAL))
        }
      >
        end token proposal
      </Button>
      <Button
        type="button"
        onClick={() => admin.createMintToken(wallet, new PublicKey(PROPOSAL))}
      >
        createMintToken
      </Button>
    </div>
